...
- [x] Standalone Xsens capture path with no D-BRAN dependency, for recording custom sessions (`scripts/xsens/xsensDataCapture.py`)
- [x] Custom OptiTrack + Xsens capture set recorded, with a ground-truth extraction and alignment pipeline
